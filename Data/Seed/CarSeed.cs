    ...
    public class CarSeed
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Car>().HasData(
                ...
                new Car { Id = 3, Label = "Car 3", VIN = "1HGCM82633A789456", Description = "Car description 3", YearOfProductionId = 3, CarBrandId = 3, CarModelId = 3, CarTrimId = 2, Status = CarStatus.InRepair },
                ...
                new Car { Id = 6, Label = "Car 6", VIN = "1HGCM82633A321654", Description = "Car description 6", YearOfProductionId = 6, CarBrandId = 6, CarModelId = 6, CarTrimId = 5, Status = CarStatus.InRepair },
                ...
                new Car { Id = 10, Label = "Car 10", VIN = "1HGCM82633A852963", Description = "Car description 10", YearOfProductionId = 10, CarBrandId = 10, CarModelId = 10, CarTrimId = 9, Status = CarStatus.InRepair }
            );
        }
    }   
}
